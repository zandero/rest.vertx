...
class RoutePathTest extends VertxTest {
    ...
    void invalidDuplicateMethodRestTest() {
        ...
        assertEquals("com.zandero.rest.jakarta.test.TestInvalidMethodRest.echo() - Method already set to: POST!", e.getMessage());
    }
    ...
    void invalidDoubleBodyRestTest() {
        ...
        assertEquals("com.zandero.rest.jakarta.test.TestDoubleBodyParamRest.echo(String arg0, String arg1) - to many body arguments given. " +
    ...
    void noPathRestTest() {
        ...
        assertEquals("com.zandero.rest.jakarta.test.TestMissingPathRest.echo() - Missing route @Path!", e.getMessage());
    }
}
