...
import com.zandero.resttest.exception.UnauthorizedAccessHandler;
import com.zandero.resttest.test.TestAuthorizationRest;
...
class RouteAuthorizationWithExceptionHandlerTest extends VertxTest {
    ...
    static void start() {
        ...
        Router router = new RestBuilder(vertx)
                            ...
                            .register(testRest)
                            .errorHandler(UnauthorizedAccessHandler.class)
                            .build();
